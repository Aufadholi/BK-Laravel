                            ...
                            <tbody>
                                @foreach ($obats as $obat)
                                    <tr class="align-middle hover:bg-blue-50 transition border-b border-blue-100">
                                        ...
                                        <td class="text-center whitespace-nowrap">
                                            {{-- Button Edit --}}
                                            <a href="{{ route('dokter.obat.edit', $obat->id) }}" class="btn btn-secondary btn-sm rounded-pill px-4 py-1 shadow-sm transition-all duration-150 hover:scale-105 bg-gray-400 rounded-full">
                                                Edit
                                            </a>
