<nav x-data="{ open: false }" class="bg-blue-300 dark:from-gray-900 dark:to-gray-700 border-b border-blue-700 dark:border-gray-700 shadow">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            <div class="flex items-center">
                <!-- Logo or Brand -->
                <a href="/" class="flex items-center gap-2">
                    <img src="/favicon.ico" alt="Logo" class="h-8 w-8 rounded-full shadow" />
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-700 dark:bg-gray-800 hover:bg-blue-800 dark:hover:bg-gray-700 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="sm:hidden bg-blue-600 dark:bg-gray-900">
        ...
        <div class="pt-4 pb-1 border-t border-blue-400 dark:border-gray-600 px-4">
            ...
            <div class="font-medium text-sm text-blue-100 dark:text-gray-400">{{ Auth::user()->email }}</div>
        </div>
